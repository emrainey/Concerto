...
$(_MODULE)_OBJS := $(ASSEMBLY:%.S=$(ODIR)/%$(OBJ_EXT)) \
...
$(_MODULE)_LIBRARIES:= $(foreach ldir,$($(_MODULE)_LDIRS),--search_path="$(ldir)") \
                       ...
                       $(foreach lib,$(SYS_STATIC_LIBS),--library=$(LIB_PRE)$(lib)$(LIB_EXT)) \
                       $(foreach linkerf,$(LINKER_FILES),--library=$(linkerf))
$(_MODULE)_AFLAGS   := $($(_MODULE)_INCLUDES)
$(_MODULE)_CFLAGS   := $($(_MODULE)_INCLUDES) $($(_MODULE)_DEFINES) $($(_MODULE)_COPT) $(CFLAGS) --gcc
