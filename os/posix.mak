...
$(_MODULE)_LN_DSO        := $(CD) $($(_MODULE)_TDIR) && $(LINK) $($(_MODULE)_OUT).$($(_MODULE)_VERSION) $($(_MODULE)_OUT)
$(_MODULE)_LN_INST_DSO   := $(LINK) $($(_MODULE)_INSTALL_LIB)/$($(_MODULE)_BIN).$($(_MODULE)_VERSION) $($(_MODULE)_INSTALL_LIB)/$($(_MODULE)_BIN)
