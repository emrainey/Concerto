...
# Clean out the $(SUBMAKEFILE) variables
_MODULE_VARS := ENTRY DEFS CFLAGS LDFLAGS STATIC_LIBS SHARED_LIBS SYS_STATIC_LIBS
_MODULE_VARS += SYS_SHARED_LIBS IDIRS LDIRS CSOURCES CUSOURCES CPPSOURCES ASSEMBLY JSOURCES
...
_MODULE_VARS += USE_GLUT USE_OPENCL USE_OPENMP TESTPATH USE_CUDA HAS_CUDA USE_OPENCV
_MODULE_VARS += BSTFILES STYFILES IMGFILES TEXFILES DOTFILES MSCFILES BIBFILES LOGFILE
_MODULE_VARS += FILE_PATH FILES SM CUFLAGS SOURCES PKGS
...
# This is just to keep track of other variables that DO NOT get cleared out
# every time we process a $(SUBMAKEFILE)
_SYSTEM_VARS := SYSIDIRS SYSLDIRS SYSDEFS SYSCFLAGS SYSLDFLAGS INSTALL_BIN INSTALL_LIB INSTALL_INC
